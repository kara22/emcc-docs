class Travel < ApplicationRecord
  ...
  validates :manager_name, presence: true, inclusion: { in: %w(Olivier_Assemat Gervais_Bouchard Antoine_Djondo Marc_Fraillon Henri_Seynave Jean_Michel_Chevrier Jean_Dupont),
